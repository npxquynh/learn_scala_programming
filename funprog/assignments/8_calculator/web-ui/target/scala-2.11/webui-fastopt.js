...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(x3.name$2)).apply__O());
      continue _eval
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(n) {
  var jsx$1 = n.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, n$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(n$1.$$und2$f).apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, n));
